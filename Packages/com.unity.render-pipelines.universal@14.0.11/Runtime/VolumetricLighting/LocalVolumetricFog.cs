...
namespace UnityEngine.Rendering.Universal
{
    ...
    public struct LocalVolumetricFogArtistParameters
    {
        ...
        internal LocalVolumetricFogEngineData ConvertToEngineData()
        {
            ...
            data.extinction = VolumetricLightingUtils.ExtinctionFromMeanFreePath(meanFreePath);
            data.scattering = VolumetricLightingUtils.ScatteringFromExtinctionAndAlbedo(data.extinction, (Vector4)albedo);
