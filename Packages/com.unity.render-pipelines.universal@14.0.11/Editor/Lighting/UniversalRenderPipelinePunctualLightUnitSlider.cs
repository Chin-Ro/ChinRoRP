...
{
    class UniversalRenderPipelinePunctualLightUnitSlider : UniversalRenderPipelinePiecewiseLightUnitSlider
    {
        public UniversalRenderPipelinePunctualLightUnitSlider(LightUnitSliderUIDescriptor descriptor) : base(descriptor) { }

        private UniversalRenderPipelineSerializedLight m_Light;
        ...
        public void Setup(LightUnit unit, UniversalRenderPipelineSerializedLight light, Editor owner)
        {
            m_Unit = unit;
            m_Light = light;
            m_Editor = owner;
        ...
        float UnitToLumen(float value)
        {
            ...
            return UniversalRenderPipelineLightUI.ConvertLightIntensity(m_Unit, LightUnit.Lumen, m_Light, m_Editor, value);
        }
        ...
        float LumenToUnit(float value)
        {
            ...
            value = UniversalRenderPipelineLightUI.ConvertLightIntensity(LightUnit.Lumen, m_Unit, m_Light, m_Editor, value);
