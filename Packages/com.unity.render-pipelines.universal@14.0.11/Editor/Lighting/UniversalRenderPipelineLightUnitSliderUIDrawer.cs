...
{
    internal class UniversalRenderPipelineLightUnitSliderUIDrawer
    {
        static UniversalRenderPipelinePiecewiseLightUnitSlider k_DirectionalLightUnitSlider;
        static UniversalRenderPipelinePunctualLightUnitSlider k_PunctualLightUnitSlider;
        static UniversalRenderPipelinePiecewiseLightUnitSlider k_ExposureSlider;
        
        static UniversalRenderPipelineLightUnitSliderUIDrawer()
        {
            // Maintain a unique slider for directional/lux.
            k_DirectionalLightUnitSlider = new UniversalRenderPipelinePiecewiseLightUnitSlider(LightUnitSliderDescriptors.LuxDescriptor);

            // Internally, slider is always in terms of lumens, so that the slider is uniform for all light units.
            k_PunctualLightUnitSlider = new UniversalRenderPipelinePunctualLightUnitSlider(LightUnitSliderDescriptors.LumenDescriptor);

            // Exposure is in EV100, but we load a separate due to the different icon set.
            k_ExposureSlider = new UniversalRenderPipelinePiecewiseLightUnitSlider(LightUnitSliderDescriptors.ExposureDescriptor);
        }
        ...
        public void Draw(UniversalLightType type, LightUnit lightUnit, SerializedProperty value, Rect rect, UniversalRenderPipelineSerializedLight light, Editor owner)
        {
        ...
        void DrawPunctualLightUnitSlider(LightUnit lightUnit, SerializedProperty value, Rect rect, UniversalRenderPipelineSerializedLight light, Editor owner)
        {
