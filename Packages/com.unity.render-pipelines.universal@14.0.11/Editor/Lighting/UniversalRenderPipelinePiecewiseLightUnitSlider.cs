...
{
    public class UniversalRenderPipelinePiecewiseLightUnitSlider : LightUnitSlider
    {
        struct Piece
        {
        ...
        public UniversalRenderPipelinePiecewiseLightUnitSlider(LightUnitSliderUIDescriptor descriptor) : base(descriptor)
        {
