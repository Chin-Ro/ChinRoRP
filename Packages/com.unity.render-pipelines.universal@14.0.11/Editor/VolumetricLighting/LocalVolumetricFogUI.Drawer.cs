...
namespace UnityEditor.Rendering.Universal
{
    ...
    static partial class LocalVolumetricFogUI
    {
        ...
        static void Drawer_VolumeContent(SerializedLocalVolumetricFog serialized, Editor owner)
        {
            ...
            {
                CoreEditorUtils.DrawVector6(Styles.s_BlendLabel, serialized.editorPositiveFade, serialized.editorNegativeFade, Vector3.zero, serializedSize, Styles.k_HandlesColor, serialized.size, false);
            }
            else
            {
                EditorGUI.BeginChangeCheck();
