#ifndef CHINRO_SHADOWS_INCLUDED
#define CHINRP_SHADOWS_INCLUDED
...
float MixBakedAndRealtimeShadow(ShadowData global, float shadow, int shadowMaskChannel, float strength)
{
...
float GetDirectionalShadowAttenuation(DirectionalShadowData directional, ShadowData global, Surface surfaceWS)
{
    ...
    else
    {
        ...
        shadow = MixBakedAndRealtimeShadow(global, shadow, directional.shadowMaskChannel, directional.strength);
    }
    return shadow;
}
...
float GetOtherShadowAttenuation(OtherShadowData other, ShadowData global, Surface surfaceWS)
{
    ...
    else
    {
        ...
        shadow = MixBakedAndRealtimeShadow(global, shadow, other.shadowMaskChannel, other.strength);
    }
    return shadow;
}
