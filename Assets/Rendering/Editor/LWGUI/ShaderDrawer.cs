...
namespace Rendering.Editor.LWGUI
{
	...
	public class MinMaxSliderDrawer : SubDrawer
	{
														...
														PerFrameData     inoutPerFrameData)
		{
			if (string.IsNullOrEmpty(_minPropName)
			 ...
			 || !inoutPerFrameData.propertyDatas.ContainsKey(_minPropName)
			 || !inoutPerFrameData.propertyDatas.ContainsKey(_maxPropName)
			   )
			{
	...
	public class TexDrawer : SubDrawer
	{
		...
		private ColorDrawer _colorDrawer = new ColorDrawer();
	...
	public class ColorDrawer : SubDrawer
	{
		...
		public ColorDrawer() : this(string.Empty, String.Empty, String.Empty,
			String.Empty) { }
		
		public ColorDrawer(string group) : this(group, String.Empty, String.Empty,
			String.Empty) { }
		public ColorDrawer(string group, string color2) : this(group, color2, String.Empty,
			String.Empty) { }

		public ColorDrawer(string group, string color2, string color3) : this(group, color2,
			color3, String.Empty) { }
		...
		public ColorDrawer(float showAlpha = 1f) : this(String.Empty, String.Empty, String.Empty,
			String.Empty, showAlpha) { }

		public ColorDrawer(string group, float showAlpha = 1f) : this(group, String.Empty, String.Empty,
			String.Empty, showAlpha) { }

		public ColorDrawer(string group, string color2, float showAlpha = 1f) : this(group, color2, String.Empty,
			String.Empty, showAlpha) { }

		public ColorDrawer(string group, string color2, string color3, float showAlpha = 1f) : this(group, color2,
			color3, String.Empty, showAlpha) { }
		
		public ColorDrawer(string group, string color2, string color3, string color4, float showAlpha = 1f)
		{
			this.group = group;
			this._colorStrings[0] = color2;
			this._colorStrings[1] = color3;
			this._colorStrings[2] = color4;
			_showAlpha = !(showAlpha < 1f);
		}
		...
		public override void DrawProp(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				dst = EditorGUI.ColorField(r, GUIContent.none, src, true, _showAlpha, isHdr
