...
namespace Rendering.Editor.LWGUI
{
	...
	public class LWGUI : ShaderGUI
	{
		...
		public LWGUI()
		{
			_background = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Rendering/Editor/Icons/Backgrounds/8.jpg");
		}

		public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
		{
			GUI.DrawTexture(new Rect(0, 0, Screen.width, Screen.height), _background, ScaleMode.ScaleAndCrop, true, 0f,
				     new Color(1f, 1f, 1f, 0.03f), 0f, 0f);
			this.props = props;
			...
			if (o != null)
			{
						...
						// Visibility
						{
							...
							if (propStaticData.parent != null
							    && (!MetaDataHelper.GetParentPropertyVisibility(propStaticData.parent, material, this)
							        || !MetaDataHelper.GetParentPropertyVisibility(propStaticData.parent.parent,
								        material, this)))
								continue;
						}
				...
				if (o.IsKeywordEnabled("_EMISSION"))
				{
